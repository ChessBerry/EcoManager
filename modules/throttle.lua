...
local constructionCategories = {
	...
	{name="Building", category = categories.STRUCTURE - categories.MASSEXTRACTION - categories.ENERGYPRODUCTION - (categories.FACTORY - categories.SUPPORTFACTORY) - categories.DEFENSE, priority = 85}
}
